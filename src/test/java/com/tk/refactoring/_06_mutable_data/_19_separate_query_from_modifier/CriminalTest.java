package com.tk.refactoring._06_mutable_data._19_separate_query_from_modifier;
...
class CriminalTest {
    ...
    void alertForMiscreant() {
        ...
        found = criminal.findMiscreant(List.of(new Person("taekyung"), new Person("seaking")));
        assertEquals("", found);
    }
